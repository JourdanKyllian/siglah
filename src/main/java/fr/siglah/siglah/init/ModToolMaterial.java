...
public enum ModToolMaterial implements ToolMaterial {
    GIVRE_FER(2, 500, 6.0F, 2.0F, 15, () -> Ingredient.ofItems(ModItems.GIVRE_FER_INGOT));
    ...
    private final Supplier<Ingredient> repairIngredient; // Remplacement de Lazy par Supplier
    ...
    ModToolMaterial(int miningLevel, int itemDurability, float miningSpeed, float attackDamage, int enchantability, Supplier<Ingredient> repairIngredient) {
        ...
        // Utilisation de Guava pour mémoriser le résultat (le comportement "Lazy")
